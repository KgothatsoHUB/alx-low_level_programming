 ...
 * @argc: The numb of arg supply the program.
 * @argv: Array of pointers to arg.
 *
 * Return: 0 on (success).
 *
 *Description: the argument count is incorrect - exit code 97.
 *file_from does'nt exist or can't be read - exit code 98.
 *file_to cant be created or written to - exit code 99.
 *file_to or file_from cant be closed - exit code 100.
 **/
