 ...
 * @e_ident: pointer to an array containing ELF magic numbers
 *
 * Description: Magic numbers are separated by spaces, not indents.
 **/
void print_magic(unsigned char *e_ident)
{
	int index;
...
/**
 * main - Show the info contained in the ELF header
 * at the start of the ELF file.
 * @argc: The number of args supplied to the program
 * @argv: An array of pointers leading to the args
 *
 * Return: 0 on success
 *
